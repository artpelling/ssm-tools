...
Python package for reduced order modelling of acoustics state space systems with the Eigensystem Realization Algorithm (ERA).

The package wraps [`pymor`](https://pymor.org) reductors for use with [`pyfar`](https://pyfar.org) signals to remove boilerplate code and assure compatibility.
...
- https://doi.org/10.1016/j.ymssp.2025.113613

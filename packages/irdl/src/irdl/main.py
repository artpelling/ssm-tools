...
def fabian(
    ...
    hato: int = typer.Option(
        0,
        help="Head-above-torso-rotation of HRTFs in degrees. Either 0, 10, 20, 30, 40, 50, 310, 320, 330, 340 or 350.",
    ),
    path: str = typer.Option(
        pooch.os_cache("irdl"),
        help="Path to the directory where the data should be stored. Will be overwritten, if the environment variable `IRDL_DATA_DIR` is set. Default is the user cache directory.",
    ),
):
